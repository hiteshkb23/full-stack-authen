/*
//defines a React component for a User Profile page
Its main purposes are:
To allow a logged-in user to fetch their own details (like email and username).
To provide a logout button that ends the user's session and redirects them to the login page.
*/
...
export default function UserProfile() {
    ...
    const logout = async () => {
        try {
            //Shows a loading indicator and sends an HTTP GET request to your backend API endpoint
            //(/api/users/logout) to destroy the user's session (likely by clearing a cookie)   
            await axios.get('/api/users/logout');
            toast.success('Logout successful');  //Shows a success pop-up notification.
    ...
    //his function is triggered when the "GetUser Details" button is clicked.
    const getUserDetails = async () => {
        try {
            /*
            Shows a loading indicator for this specific action and Sends an HTTP GET 
            request to your /api/users/me endpoint. This endpoint is expected to identify 
            the user (probably from a token or cookie) and return their data.
            then
            setUserData(res.data.data);: It takes the user data from the API response 
            (specifically from res.data.data) and saves it in the userData state. 
            This will cause the component to re-render and display the new data.
            */
...
//same as above but with alot more css
    return (
